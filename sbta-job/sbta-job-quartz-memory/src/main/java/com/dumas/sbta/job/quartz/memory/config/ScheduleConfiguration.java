...
import com.dumas.sbta.job.quartz.memory.job.Demo01Job;
...
public class ScheduleConfiguration {
    ...
    public static class DemoJob01Configuration {
        ...
        public JobDetail demoJob01() {
            return JobBuilder.newJob(Demo01Job.class)
        ...
        public Trigger demoJob01Trigger() {
            ...
            return TriggerBuilder.newTrigger()
                    ...
                    .withSchedule(scheduleBuilder).build(); // 对应 Schedule 为 scheduleBuilder
        }
    }
