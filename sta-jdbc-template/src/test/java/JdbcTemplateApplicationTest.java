import com.dumas.sta.jdbc.template.JdbcTemplateApplication;
import com.dumas.sta.jdbc.template.entity.User;
 ...
 * @author dumas
 * @desc TODO
 * @date 2022/04/02 17:23
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = JdbcTemplateApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class JdbcTemplateApplicationTest {
    private static final Logger log = LoggerFactory.getLogger(JdbcTemplateApplicationTest.class);
