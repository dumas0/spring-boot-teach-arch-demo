package com.dumas.sta.tk.mybatis;

import com.dumas.sta.tk.mybatis.entity.User;
import com.dumas.sta.tk.mybatis.mapper.UserMapper;
 ...
 * @author dumas
 * @desc TODO
 * @date 2022/04/05 15:04
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = TkMyBatisApplication.class)
public class TkMyBatisApplicationTest {

    private static final Logger log = LoggerFactory.getLogger(TkMyBatisApplicationTest.class);
