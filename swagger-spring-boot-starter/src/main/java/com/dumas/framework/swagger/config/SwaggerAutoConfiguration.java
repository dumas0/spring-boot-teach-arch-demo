...
public class SwaggerAutoConfiguration {
    ...
    public Docket petApi(){
        ...
        ResponseMessage message4 = new ResponseMessageBuilder().code(503).message("服务器过载引起的错误").responseModel(new ModelRef("服务器过载引起的错误")).build();
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(docket.getGroupName()).select()
                ...
                .pathMapping("/").directModelSubstitute(LocalDate.class, String.class).useDefaultResponseMessages(false)
